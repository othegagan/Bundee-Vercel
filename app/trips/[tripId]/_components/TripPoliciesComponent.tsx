        ...
        <div className='flex flex-col gap-2 w-full'>
            ...
            <div className='flex gap-2 items-center justify-between w-full'>
                <div className='text-md w-fit flex flex-col  gap-1'>
                    <p className='text-14'>Cancelation Policy</p>
                    <p className='text-12'>Free Cancellation until {format(calFreeCancellationDate(), 'PPP')}</p>
                </div>
            ...
            <div className='flex gap-2 items-center justify-between w-fullD'>
                <div className='text-md w-fit flex flex-col  gap-2'>
                    <p className='text-14'>Vehicle Policy</p>
                </div>
                <Link href={'/privacy'} className='underline underline-offset-2'>
                    Read More
                </Link>

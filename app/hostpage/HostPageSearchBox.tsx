...
export default function HostPageSearchBox() {
    ...
    const redirectToVech = () => {
        ...
        const newUrl = `city=${city}&latitude=${latitude}&longitude=${longitude}&startDate=${startDate}&endDate=${endDate}&startTime=${startTime}&endTime=${endTime}&isAirport=${isAirport}`;

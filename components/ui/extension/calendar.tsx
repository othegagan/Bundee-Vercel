...
const _CalendarGrid = ({ className, weekdayStyle = 'short', ...props }: CalendarGridProps) => (
    <CalendarGrid weekdayStyle={weekdayStyle} className={cn('mt-4 w-full border-collapse space-y-1', className)} {...props} />
);
